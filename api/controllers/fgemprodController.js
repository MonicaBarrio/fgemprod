...
exports.create_a_products = function(req, res) {
  ...
  new_products.disconts = req.body.disconts;

  new_products.reviews.stars = req.body.stars;
  new_products.reviews.comments = req.body.comments;
  new_products.reviews.author = req.body.author;
  new_products.reviews.email = req.body.email;
